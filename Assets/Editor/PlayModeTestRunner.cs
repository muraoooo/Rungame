...
namespace Unity.AI.Assistant.PlayModeTest
{
    ...
    internal static class PlayModeTestRunner
    {
        ...
        private class TestResult
        {
            ...
            public string forestElementCount;
        }

        private static string RunTestLogic()
        {
            var player = GameObject.FindGameObjectWithTag("Player");
            var forest = GameObject.Find("ForestParallax");
            
            string pScale = player != null ? player.transform.localScale.ToString() : "null";
            string fCount = forest != null ? forest.transform.childCount.ToString() : "null";

            return JsonUtility.ToJson(new TestResult
            {
                success = true,
                playerScale = pScale,
                forestElementCount = fCount,
                logs = _capturedLogs.ToArray()
            });
        }
    }
